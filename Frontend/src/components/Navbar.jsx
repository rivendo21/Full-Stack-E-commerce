        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              <Link
                to="/cart"
                className="relative group text-gray-300 hover:text-blue-400 transition duration-300 ease-in-out flex flex-row items-center gap-1"
              >
            ...
            {isAdmin && (
              <Link
                to={"/admin-dashboard"}
                className="bg-blue-700 text-white px-3 py-1 rounded hover:bg-blue-600 transition duration-300 ease-in-out flex flex-row items-center gap-1"
              >
                {" "}
